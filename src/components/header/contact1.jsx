...
const Contact1 = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const existingContact = JSON.parse(localStorage.getItem("Contact1")) || [];
    const updatedContact = [...existingContact, newcontact];
    localStorage.setItem("Contact1", JSON.stringify(updatedContact));
  ...
  return (
    <div>
      <h1>
        <strong>Supplier wants to know more about you</strong>
      </h1>
